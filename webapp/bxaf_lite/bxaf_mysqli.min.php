...
class bxaf_mysqli
{
    ...
    private $defaults = [
        ...
        "charset" => "utf8",
        "show_error" => 0,
        "error_output" => "bxaf_mysqli.errors.txt",
    ];
    function __construct($opt = [])
    {
        ...
        if (isset($opt["mysqli"])) {
            if ($opt["mysqli"] instanceof mysqli) {
                ...
                $this->error(
                    "mysqli option must be valid instance of mysqli class"
                );
            }
        }
        ...
        mysqli_set_charset($this->conn, $opt["charset"]) or
    ...
    private function prepare_query($args)
    {
        ...
        if ($anum <= 0) {
            ...
            $this->error(
                "Number of args ($anum) doesn't match number of placeholders ($pnum) in [$raw]"
            );
        }
